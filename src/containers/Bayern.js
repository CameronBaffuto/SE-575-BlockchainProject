...
class BayernLayout extends Component {
     constructor(props) {
         super(props)
         this.state = {
             index: 1,
             ...
             nonce: 34523,
             data: 'Bayern Munich vs Borussia Dortmund',
         }
     }
    ...
    render() {
        return (
            <div>
                ...
                <Card.Text>
                Bayern Munich take on Borussia Dortmund in Der Klassiker live on One View Sports!
                </Card.Text>
                </Card.Body>
                <Card.Body>
                </Card.Body>
